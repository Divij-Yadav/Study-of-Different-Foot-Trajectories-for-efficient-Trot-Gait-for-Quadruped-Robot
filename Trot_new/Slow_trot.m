% When duty factor is not 0.5

function[X1,X2,X3,X4,Z1,Z2,Z3,Z4,Y1,Y2,Y3,Y4]=Slow_trot(S,T,x1,x2,x3,x4,z1,z2,z3,z4,y1,y2,y3,y4,C,CC,Vx,Vz,H,D)
    % V=(5*S)/T;
    t=(D*T)/2;
    V0=(-S)/(2*t);
    ttt=ones(1,160);
    ...
    if CC==C
          ...
          t1=linspace(0,t,20); % start phase
          t2=linspace(t,0.5*T,20); % swing rise
          t3=linspace(0.5*T,T-t,20); % swing fall
          t4=linspace(0,2*t,20); % stance phase

          % Pair 1

          % LF leg (1)
          xl1_1=x1+V0*t1; % start
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(t,0.5*T,xl1_1(end),xl1_1(end)+(0.5*S),V0,Vx,0,0);
          xl1_2=C0+C1*(t2)+C2*(t2.^2)+C3*(t2.^3)+C4*(t2.^4)+C5*(t2.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T,T-t,xl1_1(end)+(0.5*S),xl1_1(end)+(S),Vx,V0,0,0);
          ...
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(t,0.5*T,z1,z1+H,0,Vz,0,0);
          zl1_2=C0+C1*(t2)+C2*(t2.^2)+C3*(t2.^3)+C4*(t2.^4)+C5*(t2.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T,T-t,z1+H,z1,Vz,0,0,0);
          ...
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(t,0.5*T,xl4_1(end),xl4_1(end)+(0.5*S),V0,Vx,0,0);
          xl4_2=C0+C1*(t2)+C2*(t2.^2)+C3*(t2.^3)+C4*(t2.^4)+C5*(t2.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T,T-t,xl4_1(end)+(0.5*S),xl4_1(end)+(S),Vx,V0,0,0);
          ...
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(t,0.5*T,z4,z4+H,0,Vz,0,0);
          zl4_2=C0+C1*(t2)+C2*(t2.^2)+C3*(t2.^3)+C4*(t2.^4)+C5*(t2.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T,T-t,z4+H,z4,Vz,0,0,0);
          ...
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(t,0.5*T,xl2_2(end),xl2_2(end)+(0.5*S),V0,Vx,0,0);
          xl2_3=C0+C1*(t2)+C2*(t2.^2)+C3*(t2.^3)+C4*(t2.^4)+C5*(t2.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T,T-t,xl2_2(end)+(0.5*S),xl2_2(end)+(S),Vx,V0,0,0);
          ...
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(t,0.5*T,z2,z2+H,0,Vz,0,0);
          zl2_3=C0+C1*(t2)+C2*(t2.^2)+C3*(t2.^3)+C4*(t2.^4)+C5*(t2.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T,T-t,z2+H,z2,Vz,0,0,0);
          ...
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(t,0.5*T,xl3_2(end),xl3_2(end)+(0.5*S),V0,Vx,0,0);
          xl3_3=C0+C1*(t2)+C2*(t2.^2)+C3*(t2.^3)+C4*(t2.^4)+C5*(t2.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T,T-t,xl3_2(end)+(0.5*S),xl3_2(end)+(S),Vx,V0,0,0);
          ...
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(t,0.5*T,z3,z3+H,0,Vz,0,0);
          zl3_3=C0+C1*(t2)+C2*(t2.^2)+C3*(t2.^3)+C4*(t2.^4)+C5*(t2.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T,T-t,z3+H,z3,Vz,0,0,0);
          ...
          t=(D*T)/2;
          tt=ones(1,80); % still phase
          t5=linspace(0,0.5*T-t,30); % swing rise
          t6=linspace(0.5*T-t,T-2*t,30); % swing fall
          t7=linspace(0,2*t,20); % stance phase

          % Pair 1

          % LF leg (1)
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0,0.5*T-t,x1,x1+(0.5*S),0,Vx,0,0);
          xl1_1=C0+C1*(t5)+C2*(t5.^2)+C3*(t5.^3)+C4*(t5.^4)+C5*(t5.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T-t,T-2*t,x1+(0.5*S),x1+(S),Vx,V0,0,0);
          ...
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0,0.5*T-t,z1,z1+H,0,Vz,0,0);
          zl1_1=C0+C1*(t5)+C2*(t5.^2)+C3*(t5.^3)+C4*(t5.^4)+C5*(t5.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T-t,T-2*t,z1+H,z1,Vz,0,0,0);
          ...
          % RH leg (4)
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0,0.5*T-t,x4,x4+(0.5*S),0,Vx,0,0);
          xl4_1=C0+C1*(t5)+C2*(t5.^2)+C3*(t5.^3)+C4*(t5.^4)+C5*(t5.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T-t,T-2*t,x4+(0.5*S),x4+(S),Vx,V0,0,0);
          ...
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0,0.5*T-t,z4,z4+H,0,Vz,0,0);
          zl4_1=C0+C1*(t5)+C2*(t5.^2)+C3*(t5.^3)+C4*(t5.^4)+C5*(t5.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T-t,T-2*t,z4+H,z4,Vz,0,0,0);
          ...
          % RF leg (2)
          xl2_1=x2*tt; % still
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0,0.5*T-t,x2,x2+(0.5*S),0,Vx,0,0);
          xl2_2=C0+C1*(t5)+C2*(t5.^2)+C3*(t5.^3)+C4*(t5.^4)+C5*(t5.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T-t,T-2*t,x2+(0.5*S),x2+(S),Vx,V0,0,0);
          xl2_3=C0+C1*(t6)+C2*(t6.^2)+C3*(t6.^3)+C4*(t6.^4)+C5*(t6.^5); % swing fall
          xl2_4=(xl2_3(end))+V0*t7; % stance
          X2=[xl2_1,xl2_2,xl2_3,xl2_4];
          
          zl2_1=z2*tt; % still
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0,0.5*T-t,z2,z2+H,0,Vz,0,0);
          zl2_2=C0+C1*(t5)+C2*(t5.^2)+C3*(t5.^3)+C4*(t5.^4)+C5*(t5.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T-t,T-2*t,z2+H,z2,Vz,0,0,0);
          ...
          % LH leg (3)
          xl3_1=x3*tt; % still
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0,0.5*T-t,x3,x3+(0.5*S),0,Vx,0,0);
          xl3_2=C0+C1*(t5)+C2*(t5.^2)+C3*(t5.^3)+C4*(t5.^4)+C5*(t5.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T-t,T-2*t,x3+(0.5*S),x3+(S),Vx,V0,0,0);
          xl3_3=C0+C1*(t6)+C2*(t6.^2)+C3*(t6.^3)+C4*(t6.^4)+C5*(t6.^5); % swing fall
          xl3_4=(xl3_3(end))+V0*t7; % stance
          X3=[xl3_1,xl3_2,xl3_3,xl3_4];

          zl3_1=z3*tt; % still
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0,0.5*T-t,z3,z3+H,0,Vz,0,0);
          zl3_2=C0+C1*(t5)+C2*(t5.^2)+C3*(t5.^3)+C4*(t5.^4)+C5*(t5.^5); % swing rise
          [C0,C1,C2,C3,C4,C5]=Quintic_Coefficient_calculator(0.5*T-t,T-2*t,z3+H,z3,Vz,0,0,0);
